...
const StatsRow = ({ date, time, duration, activity, tasks, score }: StatsRowProps) => (
  <div className="flex items-center justify-between w-full p-4 bg-[#1c2c56]/40 rounded-lg">
    ...
    <div className="text-white font-['Kdam_Thmor_Pro'] text-lg">{tasks || '-'}</div>
    <div className="flex items-center gap-4">
      ...
      <div className="text-white font-['Kdam_Thmor_Pro'] text-lg w-16">{score}</div>
    </div>
  </div>
);
      ...
      <div className="flex flex-col items-center justify-center gap-12 mt-16">
        ...
        <div className="w-full max-w-[1540px]">
          ...
          <div className="grid grid-cols-6 gap-4 mb-4 px-4">
            <div className="text-white font-['Kdam_Thmor_Pro'] text-xl">Date</div>
            <div className="text-white font-['Kdam_Thmor_Pro'] text-xl">Time</div>
            <div className="text-white font-['Kdam_Thmor_Pro'] text-xl">Duration Target</div>
            <div className="text-white font-['Kdam_Thmor_Pro'] text-xl">Activity</div>
            <div className="text-white font-['Kdam_Thmor_Pro'] text-xl">Tasks</div>
            <div className="text-white font-['Kdam_Thmor_Pro'] text-xl">Score</div>
          </div>
